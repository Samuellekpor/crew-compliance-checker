...
| EASA-FTL-205-TABLE | ORO.FTL.205(b)(1)–(2) | Daily FDP vs Table 2 (acclimatised) or Table 3 (unknown), by start time and sectors |
...
**Not implemented:** ORO.FTL.205 extensions, CS-FTL.1, WOCL reductions beyond the table, not-acclimatised FDP (outside Tables 2/3), augmented FDP, split duty, standby, reserve, reduced rest, commander’s discretion, 2 local nights inside RERRP, operator-specific FTSS.
...
| FAA-117-13-TABLE-B | § 117.13, Table B | Unaugmented daily FDP vs Table B; −30 min if unknown / not acclimated (§ 117.13(b)) |
...
**Not implemented:** Tables A/C, § 117.11, § 117.17, split duty, reserve, extensions, § 117.25(c)(d)(f)(g), § 117.27, 8-hour sleep opportunity.
...
| UK-CAA-FTL-205-TABLE | UK ORO.FTL.205(b)(1)–(2) | Daily FDP vs Table 2 / Table 3 (same cells as EASA) |
...
**Not implemented:** CAP 371 FTLS schemes, CS-FTL.1 extensions, ANO 2016 art. 177 as a separate rule (100 h / 28 days is covered via UK-FTL-210-B1).
...
| TC-700-28-TABLE | CAR 700.28(2)–(4) | Daily FDP vs start-time / flight-count tables; column set by average scheduled flight duration |
| TC-700-40 | CAR 700.40(1) | Rest before next duty < 12 h home / 10 h away |

**Not implemented:** 700.28 acclimatization adjustments and 700.28(5), 700.27(1)(d) single-pilot 8/24, 700.29(1)(d) 70 h option, 700.103 medevac, FRMS, reserve/standby counting.
...
| CASA-48-A2-T21 | App. 2 Table 2.1 | Daily FDP for an acclimatised FCM by start time and sectors |
